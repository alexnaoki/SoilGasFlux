...
You can find the Open parametric chamber deisng in the following [Onshape](https://cad.onshape.com/documents?nodeId=4b53f2352ecc925dbfa1de6a&resourceType=folder) file
<img src="https://github.com/alexnaoki/SoilGasFlux/blob/main/media/chamber_open.png" width=50% height=50%>


## Code sequence protocol

You can find the code in the following [repository](https://github.com/alexnaoki/SoilGasFlux-RaspberryPi).


<img src="https://github.com/alexnaoki/SoilGasFlux/blob/main/media/code_sequence_protocol.png" width=100% height=100%>
